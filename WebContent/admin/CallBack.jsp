...
%>
           ...
           %>
                  <tbody id="all">
                   ...
                   ArrayList<call_back> cb=apiController.callBackData();
      ...
      <td><%=count++%></td>
      <td><%=cb.get(i).getName()%></td>
      <td><%=cb.get(i).getEmail()%></td>
      <td><%=cb.get(i).getPhone()%></td>
      <td><%=cb.get(i).getSubmission_date() %></td>
      <td><%=cb.get(i).getTimeslot_one() %></td>
      <td><%=cb.get(i).getTimeslot_two() %></td>
      <td><%=cb.get(i).getTimeslot_three() %></td>
                  </tr>
                  <%} %>
