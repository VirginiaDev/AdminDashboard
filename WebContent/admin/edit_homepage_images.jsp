...
%>
           ...
           %>
                  <tbody id="all">
                   ...
                   ArrayList<edit_homepage_images> eh=apiController.fetchHomepageImages();
      ...
      <td><%=count++%></td>
      <td><img src="../<%=eh.get(i).getFileName()%>"></td>
      <td><%=eh.get(i).getLast_updated()%></td>
      <td><%=eh.get(i).getLinks()%></td>
      <!--  <td><a href="">Image</a><br><a href="../AdminController?userAction=1&id=<%=eh.get(i).getId()%>">Link</a></td>-->
      <td><a href="">Image</a><br><button id="myBtn">Link</button></td>
                  </tr>
                  <%} %>
...
<div id="myModal" class="modal">
 <div class="modal-content">
    ...
    <form action = "AdminController" method="POST" name = "uForm" style="height: 125px;">
<input type = "hidden" name = "userAction">
<input type = "hidden" name = "id">
<input type = "text" name = "link" value = "" style="width:35%;padding: 0.5%;margin: 2%;">
