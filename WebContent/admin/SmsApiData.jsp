...
%>
           ...
           %>
                  <tbody id="all">
                   ...
                   ArrayList<SmsApiData> eh=apiController.fetchSmsApiData();
      ...
      <td><%=count++%></td>
      <td><%=eh.get(i).getSenderId()%></td>
      <td><%=eh.get(i).getMobile()%></td>
      <td><%=eh.get(i).getClientId()%></td>
      <td><%=eh.get(i).getMessage()%></td>
      <td><%=eh.get(i).getApiKey()%></td>
      <td><%=eh.get(i).getSubmissionTime()%></td>
                  </tr>
                  <%} %>
