<!DOCTYPE html>
<%@page import="beans.GeneralInquiries"%>
...
%>
           ...
           %>
                  <tbody id="all">
                   ...
                   ArrayList<GeneralInquiries> eh=apiController.fetchGeneralInquiries();
      ...
      <td><%=eh.get(i).getCompanyWebsite()%></td>
      <td><%=eh.get(i).getDropALine()%></td>
      <td><%=eh.get(i).getTrashed()%></td>
      <td><%=eh.get(i).getSubmissionDate()%></td>
                  </tr>
                  <%} %>
