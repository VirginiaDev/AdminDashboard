...
%>
           ...
           %>
                  <tbody id="all">
                   ...
                   ArrayList<consultations> cb=apiController.fetchConsultations();
      ...
      <td><%=cb.get(i).getCountry() %></td>
      <td><%=cb.get(i).getServices() %></td>
      <td><%=cb.get(i).getBudget() %></td>
      <td><%=cb.get(i).getWebEmail() %></td>
      <td><%=cb.get(i).getMsg() %></td>
                  </tr>
                  <%} %>
